<template>
  <div class="user">
    ...
    <van-grid center class="userTop" :border="false">
      <van-grid-item
        icon="http://img5.imgtn.bdimg.com/it/u=4218530414,2263115521&fm=26&gp=0.jpg"
        :text="actName"
      />
    </van-grid>
    <van-cell-group class="userList" v-show="userorGl==true">
      ...
      <van-cell title="保险详情" to="/serviceManagent/insurance" value="&gt;" />
      <van-cell title="投诉建议" to="/serviceManagent/serve" value="&gt;" />
      <van-cell title="通知详情" to="/serviceManagent/inform" value="&gt;" />
      <van-cell title="砍价" to="/serviceManagent/bargainlist" value="&gt;" />
